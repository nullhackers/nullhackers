...
export default function Navbar() {
  ...
  return (
    <nav className={`navbar glass ${scrolled ? 'navbar--scrolled' : ''}`} id="navbar">
      <div className="navbar__inner">
        ...
        <div className="navbar__actions">
          <a
            href="https://github.com/nullhackers"
            target="_blank"
            rel="noopener noreferrer"
            className="navbar__github"
            aria-label="Nullhackers on GitHub"
          >
      ...
      {/* Mobile menu overlay */}
      <div className={`navbar__mobile-menu glass ${menuOpen ? 'open' : ''}`}>
